...
public class ViewPagerUtil {
    ...
    public void setupIndicator(Activity activity, ViewPager2 viewPager2, LinearLayout pagerDots, int size){
        ...
        for (int i = 0; i <size; i++){
            ...
            ivArrayDotsPager[i].setImageResource(R.drawable.viewpager_indicator_selected);
        ...
        ivArrayDotsPager[0].setImageResource(R.drawable.viewpager_indicator_unselected);
        ...
        ViewPager2.OnPageChangeCallback onPageChangeCallback =
                new ViewPager2.OnPageChangeCallback() {
                    ...
                    @Override public void onPageSelected(int position){
                        ...
                        ivArrayDotsPager[position].setImageResource(R.drawable.viewpager_indicator_unselected);
                    }
