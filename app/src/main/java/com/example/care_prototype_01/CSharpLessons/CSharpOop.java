...
public class CSharpOop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csharp_oop);
        ...
        btn_back.setOnClickListener(view -> {
            Intent OpenCOop = new Intent(this, CSharpLanguageActivity.class);
